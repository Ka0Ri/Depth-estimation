...
class ResNetDepthEstimation(LightningModule):
    def __init__(self, config):
        ...
        self.encoder = torch.nn.Sequential(*(list(original_model.children())[:-3]))
...
if __name__ == '__main__':
    ...
    #for testing
    model_test = ResNetDepthEstimation.load_from_checkpoint('lightning_logs/version_3/checkpoints/epoch=16-step=7445.ckpt',config=config)
    # model_test = ViTDepthEstimation.load_from_checkpoint('lightning_logs/version_3/checkpoints/epoch=16-step=7445.ckpt',config=config)
